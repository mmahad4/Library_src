...
public class LibrarianForm extends JFrame {
	...
	public LibrarianForm() {
		...
		JButton btnNewButton = new JButton("Add Librarian"); // Listener function of the button
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) { //action performed 
			String name=textField.getText(); //reads the data from the textfield 
			String password=String.valueOf(passwordField.getPassword());//reads the data from the textfield
			String email=textField_1.getText();//reads the data from the textfield
			String address=textField_2.getText();//reads the data from the textfield
			String city=textField_3.getText();//reads the data from the textfield
			String contact=textField_4.getText();
			//reads the data from the textfield
			int i=LibrarianDao.save(name, password, email, address, city, contact); //calls the action to be performed 
			if(i>0){
