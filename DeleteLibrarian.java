...
public class DeleteLibrarian extends JFrame {
	...
	public DeleteLibrarian() {
		...
		JLabel lblEnterId = new JLabel("Enter numeric Id:"); 
		
		textField = new JTextField(); //takes the unique identifier of the librarian
		textField.setColumns(10);
		
		JButton btnDelete = new JButton("Delete");
		btnDelete.addActionListener(new ActionListener() { //calls the listener function
		...
		JButton btnNewButton = new JButton("Back"); //container alignment
...
//Shwetha_Puttamallegowda_654429387