...
public class IssueBookForm extends JFrame {
	...
	public IssueBookForm() {
		...
		btnIssueBook.addActionListener(new ActionListener() {
			...
			if(IssueBookDao.checkBook(title)){
			
			int i=IssueBookDao.save(title, studentid, studentname, studentcontact);
			if(i>0){
				...
				JOptionPane.showMessageDialog(IssueBookForm.this,"Sorry, title doesn't exist!");
